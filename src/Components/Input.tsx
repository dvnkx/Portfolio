...
const Input = ({ label, ...props }: IInputProps) => {
  return (
    <div className="relative h-12 w-full mb-12">
      <input
        className="text-words-100 flex peer h-full w-full border-b border-blue-gray-200 bg-transparent pt-10 pb-1.5  text-lg outline-0 transition-all placeholder-shown:border-words-200 focus:border-primary focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
        {...props}
      ></input>
